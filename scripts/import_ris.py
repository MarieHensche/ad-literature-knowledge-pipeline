#!/usr/bin/env python3
"""Convert RIS paper metadata into the pipeline's canonical paper CSV."""
...
def main() -> None:
    ...
    records = parse_ris(Path(args.input))
    ...
    print(f"Imported RIS records: {len(rows)}")
    print(f"Rows missing abstracts: {missing_abstracts}")
